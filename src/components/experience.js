...
const experience = () => {
  return (
    <div className='md:w-[75%] lg:w-[70%] justify-center align-middle items-center mx-auto mb-10'>
        ...
        <div className='grid md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 my-2 mb-7 mx-auto justify-items-center align-middle items-center'>
                   <div>
                   ...
                   <div className='mt-5'>
                      <p className='font-bold text-3xl'>CSS</p>
                      <p className='text-[12px]'>1 Year Experience</p>
                   </div>
